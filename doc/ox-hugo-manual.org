...
export flow*.
** Demo
[[https://github.com/kaushalmodi/ox-hugo/tree/master/test/site/content-org][Org source]] → [[https://github.com/kaushalmodi/ox-hugo/tree/master/test/site/content][Exported Markdown]] → [[https://ox-hugo.netlify.com][*Hugo published test site*]]
...
|---------------+-------------------------------------------------------------------------------------|
** Hugo test site for this package                                     :wiki:
:PROPERTIES:
:EXPORT_TITLE:
:EXPORT_FILE_NAME: Test Hugo site
:END:
An [[https://github.com/kaushalmodi/ox-hugo/tree/master/test/site][site]] with bare-bones "theme" is used to live-test the
...
4. Create a separate directory for Org content in the Hugo site base
   ...
   =content-org= ([[https://github.com/kaushalmodi/ox-hugo/tree/master/test/site][Example 1 -- =ox-hugo= test site]], [[https://gitlab.com/kaushalmodi/kaushalmodi.gitlab.io][Example 2 -- My
   blog]]).
