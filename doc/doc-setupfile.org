...
#+macro: pagelink @@hugo:{{< pagelink "$1" "@@ $2 @@hugo:" >}}@@
# Usage:
#   {{{pagelink(PAGETITLE,)}}}                -> Hyperlink to a page with that title.
#   {{{pagelink(PAGETITLE,LINKDESC)}}}        -> Hyperlink to a page with that title,
#                                                 with that description.
#   {{{pagelink(PAGETITLE#ANCHOR,LINKDESC)}}} -> Hyperlink to a page with that title#anchor,
#                                                 with that description.
