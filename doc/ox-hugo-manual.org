...
:END:
#+begin_src org
This links to the @@md:[Org Special Blocks]({​{< relref "org-special-blocks" >}})@@ page.
#+end_src

Above renders to:

This links to the @@md:[Org Special Blocks]({{< relref
"org-special-blocks" >}})@@ page.

See the [[https://orgmode.org/org.html#Quoting-HTML-tags][HTML Export inline syntax]] for reference.

/Using ~@@html:..@@~ will also export the same way./
***** ~#+md:~ or ~#+html:~
Sometimes, it might also be possible to export the whole line in the
specified backend like so:

#+begin_src org
,#+md: This links to the [Org Special Blocks]({​{< relref "org-special-blocks" >}}) page.
#+end_src
...
/Using ~#+html:..~ will also export the same way./
***** ~#+begin_export md~ or ~#+begin_export html~
#+begin_note
...
#+end_export
**** Org Macros
If you find yourself using the [[#inline-syntax][Inline Syntax]] a lot, you might benefit
from using the power of [[https://orgmode.org/manual/Macro-Replacement.html][Org Macros]].

This is best shown using the same ~relref~ shortcode example ..

Instead of always typing ~@@md:[Org Special Blocks]({​{< relref
