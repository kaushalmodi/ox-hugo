...
#+end_src
**** Auto-injecting /Bibliography/ heading
The {{{relref(auto-injecting bibliography
heading,org-cite-citations/#auto-injecting-bibliography-heading)}}}
section for Org Cite library based citations applies to ~org-ref~ as
well as they both use the same ~citeproc.el~ library.

See that section on how to customize the name of the auto-injected
heading, etc.
*** Pandoc Citations
:PROPERTIES:
