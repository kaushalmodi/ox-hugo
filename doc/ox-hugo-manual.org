...
- Whether you want *only some* headlines numbered (both in post body
  ...
  =t=.
- Whether you want to list the headings *only from the current
  section* --- /Example: ~#+toc: headlines 1 local~/.
...
1. Add below to the very-end of your Org file:
   ...
   # End:
   #+end_src
   *About Footnotes*: Here I recommend adding the =* Footnotes= header[fn:5]
