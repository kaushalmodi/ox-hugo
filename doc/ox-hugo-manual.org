...
| =draft = true=                     | =* TODO foo=                           | Subtree heading Org TODO state set to =TODO= (or =DRAFT=). See ~org-hugo-todo-keywords~ and ~org-hugo-default-draft-state~. |
| =draft = false=                    | =* DONE foo=                           | Subtree heading Org TODO state set to =DONE=. See ~org-hugo-todo-keywords~ and ~org-hugo-default-draft-state~.              |
...
| =draft = false=                  | =#+hugo_draft: false= (See ~org-hugo-default-draft-state~.) |
