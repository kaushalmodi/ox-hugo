...
- [ ] Task 4
- [X] Task 5
**** TODO Needs Blackfriday front matter
The "2/5" ratio is rendered as a fraction by Blackfriday. Need to
implement feature in [[https://github.com/kaushalmodi/ox-hugo/issues/37][Issue # 37]] so that the fraction rendering can be
disabled in the front matter (setting =[blackfriday] fractions= to
=false= [[[https://gohugo.io/getting-started/configuration/#configure-blackfriday][Ref]]]).
* Quotes                                                             :quotes:
** Consecutive quotes
:PROPERTIES:
